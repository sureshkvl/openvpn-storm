...
(function() {
  ...
  this.include = function() {
    var Objects, agent, clientRegistry, fs, plugindir, serverRegistry, userRegistry;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function(service) {
          return service.generate(function(err) {
            ...
            return service.start(function(err, instance) {
              if (err != null) {
                return agent.log("restore: openvpn " + service.id + " start failed with:", err);
              } else {
                return agent.log("restore: openvpn " + service.id + " start succeeded wtih " + instance);
              }
            });
          });
        })(service));
    ...
    this.del({
      '/openvpn/server/:server': function() {
        ...
        if (Objects[service.id] === null) {
          return this.send(404);
        }
        service = Objects[service.id];
        return service.stop((function(_this) {
          return function(res) {
            serverRegistry.remove(_this.params.server);
      ...
      '/openvpn/server/:server': function() {
        ...
        return service.update(this.body, (function(_this) {
          return function(err, results) {
            ...
            return service.reload(function(res) {
              return _this.send({
                id: service.id,
                reloaded: res
              });
    ...
    this.del({
      '/openvpn/server/:id/users/:user': function() {
        ...
        return userRegistry.deleteuser(server, user, (function(_this) {
          return function(res) {
    ...
    this.del({
      '/openvpn/client/:client': function() {
        ...
        return service.stop((function(_this) {
          return function(res) {
            clientRegistry.remove(_this.params.client);
            agent.removeServices(service);
            service.destructor();
            service = null;
            return _this.send(204);
    ...
    this.put({
      '/openvpn/server/:server/stop': function() {
        var obj, service;
        service = serverRegistry.get(this.params.server);
        if (service == null) {
          return this.send(404);
        ...
        return obj.stop((function(_this) {
          return function(res) {
            return _this.send({
              id: service.id,
              stopped: res
    ...
    this.put({
      '/openvpn/server/:server/reload': function() {
        var obj, service;
        service = serverRegistry.get(this.params.server);
        if (service == null) {
          return this.send(404);
        ...
        obj = Objects[service.id];
        return obj.reload((function(_this) {
          return function(res) {
            return _this.send({
              id: service.id,
              reloaded: res
    ...
    return this.put({
      '/openvpn/server/:server/start': function() {
        var obj, service;
        service = serverRegistry.get(this.params.server);
        if (service == null) {
          return this.send(404);
        ...
        obj = Objects[service.id];
        return obj.start((function(_this) {
