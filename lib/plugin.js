  ...
  this.include = function() {
    ...
    this.post({
      '/openvpn/server/:server/users': function() {
        var serverId, tasks, user, users, _i, _len;
        ...
        for (_i = 0, _len = users.length; _i < _len; _i++) {
          user = users[_i];
          tasks[user.id] = function(callback) {
            return vpn.adduser(serverId, user, (function(_this) {
              return function(res) {
                if (!(res instanceof Error)) {
        ...
        return async.parallel(tasks, (function(_this) {
          return function(err, results) {
            ...
            if (!((results != null) && results.length > 0)) {
              return _this.next(new Error("Unable to add openvpn users!"));
            } else {
