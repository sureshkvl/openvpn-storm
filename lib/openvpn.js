...
(function() {
  ...
  Openvpn = (function() {
    ...
    Openvpn.prototype.adduser = function(serverid, user, callback) {
      var ccdpath, configData, file, filename, gconfig, i, key, res, result, service, val, _i, _len;
      ...
      this.settings.agent.log("existing openvpn server PId for this server instance: ", res.pid);
      return exec("/bin/kill -HUP " + res.pid, (function(_this) {
        return function(error, stdout, stderr) {
          if (error) {
            return callback(new Error('SIGUP Error for openvpn server instance' + error));
          }
          _this.settings.agent.log('Reloaded openvpn instance');
