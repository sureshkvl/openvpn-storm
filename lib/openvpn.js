  ...
  Openvpn = (function() {
    ...
    Openvpn.prototype.addserver = function(server, callback) {
      ...
      return this.generateConfig(server, function(configFile) {
        ...
        data = _this.settings.agent.newInstance(null, serverInfo);
        serverInstance = _this.settings.agent.instances.add(data.id, data);
        return _this.settings.agent.start(serverInstance.id, function(key, pid) {
    ...
    Openvpn.prototype.listServers = function(callback) {
      var _this = this;
      return this.servers.list(function(res) {
        return callback(res);
      });
    };
    ...
    Openvpn.prototype.getServerbyID = function(id, callback) {
      var _this = this;
      return this.servers.get(id, function(res) {
        return callback(res);
      });
    };
    ...
    Openvpn.prototype.adduser = function(serverid, user, callback) {
      ...
      return this.getServerbyID(serverid(function(res) {
        var ccdpath, config, filename, i, id, key, service, val, _i, _len;
        if (!(res instanceof Error)) {
          ...
          id = user.id;
          return fs.writeFileSync(filename, config);
          /*
                          try
                              '''
