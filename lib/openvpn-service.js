  ...
  OpenvpnMgmtClient = (function() {
    ...
    OpenvpnMgmtClient.prototype.connect = function(options, callback) {
      ...
      this.client.on('error', (function(_this) {
        return function(err) {
          _this.settings.agent.log('vpn mgmt client connection error :', err.message);
          return callback(err, null);
        };
      })(this));
      return this.client.on('end', (function(_this) {
        return function() {
          return _this.settings.agent.log('vpn mgmt client disconnected :');
        };
      })(this));
    };
    ...
    OpenvpnMgmtClient.prototype.execute = function(command, callback) {
      if (this.client != null) {
        this.settings.agent.log("command ", command);
        this.client.write(command);
        return this.client.on("data", (function(_this) {
          return function(data) {
            var message;
            _this.settings.agent.log("in client data ", data);
            _this.settings.agent.log("vpn mgmt parsing data ", data.toString());
            message = String(data);
    ...
    OpenvpnMgmtClient.prototype.disconnect = function() {
      ...
      try {
        ...
        err = _error;
        return this.settings.agent.log("unable to properly terminate vpn mgmt client: " + this.client, err);
      }
    };
