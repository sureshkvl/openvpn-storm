...
(function() {
  var OpenvpnClientService, OpenvpnServerService, OpenvpnService, StormService, fs, merge,
  ...
  OpenvpnService = (function(_super) {
    ...
    OpenvpnService.prototype.update = function(include, callback) {
      if (this.data.id) {
        delete this.data.id;
      }
      this.data = merge(this.data, include);
