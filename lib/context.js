...
(function() {
  ...
  Start = function(context) {
    var clients, config, configObj, history, instances, ref, ref1, ref2, ref3, ref4, servers;
    ...
    instances = (ref3 = context.instances) != null ? ref3 : [];
    history = (ref4 = context.history) != null ? ref4 : [];
