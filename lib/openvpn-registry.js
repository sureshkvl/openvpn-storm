...
(function() {
  var OpenvpnService, StormData, StormRegistry, UserData, VpnServerRegistry, VpnUserRegistry,
  ...
  VpnUserRegistry = (function(_super) {
    var fs;

    __extends(VpnUserRegistry, _super);

    fs = require('fs');

    function VpnUserRegistry(filename) {
      this.on('load', function(key, val) {
        var entry;
      ...
      VpnUserRegistry.__super__.constructor.call(this, filename);
      this.on('added', function(entry) {});
    }

    VpnUserRegistry.prototype.get = function(key) {
      var entry;
      entry = VpnUserRegistry.__super__.get.call(this, key);
      if (entry == null) {
        return;
      }
    ...
    VpnUserRegistry.prototype.adduser = function(user) {
    ...
    VpnUserRegistry.prototype.deleteuser = function(server, user, callback) {
