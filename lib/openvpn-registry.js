...
(function() {
  var OpenvpnClientService, OpenvpnMgmtClient, OpenvpnRegistry, OpenvpnServerService, OpenvpnService, OpenvpnUserRegistry, StormData, StormRegistry, UserData,
  ...
  OpenvpnRegistry = (function(_super) {
    ...
    function OpenvpnRegistry(_at_svc, filename) {
      this.svc = _at_svc;
  ...
  OpenvpnUserRegistry = (function(_super) {
    ...
    OpenvpnUserRegistry.prototype.deleteuser = function(server, user, callback) {
      var ccdpath, cname, email, exists, file, filename, mgmtClient, options, path;
      path = require('path');
      ...
      return fs.unlink(filename, (function(_this) {
        return function(err) {
          if (err) {
            ...
            return mgmtClient.connect(options, function(err, client) {
              var cmd;
              if (!err) {
                cmd = "kill " + cname;
                return mgmtClient.execute(cmd, function(err, result) {
